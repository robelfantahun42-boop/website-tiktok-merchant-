...
// Include required files - FIXED PATHS for InfinityFree
require_once 'includes/init.php';        // Now looks in htdocs/includes/
require_once 'includes/functions.php';   // Now looks in htdocs/includes/
require_once 'includes/auth.php';        // Now looks in htdocs/includes/
